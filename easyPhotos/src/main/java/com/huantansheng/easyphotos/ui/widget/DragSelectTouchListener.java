...
public class DragSelectTouchListener implements RecyclerView.OnItemTouchListener{
    ...
    private DragSelectTouchListener.OnDragSelectListener mSelectListener;
     ...
     */
    public DragSelectTouchListener withSelectListener(DragSelectTouchListener.OnDragSelectListener selectListener)
    {
    ...
    public void startDragSelection(int position)
    {
        ...
        mLastStart = position;
        mLastEnd = position;
        if (mSelectListener != null && mSelectListener instanceof DragSelectTouchListener.OnAdvancedDragSelectListener)
            ((DragSelectTouchListener.OnAdvancedDragSelectListener)mSelectListener).onSelectionStarted(position);
    }
    ...
    private void reset()
    {
        setIsActive(false);
        if (mSelectListener != null && mSelectListener instanceof DragSelectTouchListener.OnAdvancedDragSelectListener)
            ((DragSelectTouchListener.OnAdvancedDragSelectListener)mSelectListener).onSelectionFinished(mEnd);
    ...
    public interface OnAdvancedDragSelectListener extends DragSelectTouchListener.OnDragSelectListener
    {
        /**
